...
sessionRoutes.get('/api/hermes/sessions/deleted', ctrl.listDeleted)
...
sessionRoutes.post('/api/hermes/sessions/:id/restore', ctrl.restore)
sessionRoutes.delete('/api/hermes/sessions/:id/permanent', ctrl.permanentDelete)
